...
class PlotBuilderData3D:
    def __init__(self, args):
        for i in [
            ...
            if 'x_ticktext' in args: 
                self.x_ticktext = args['x_ticktext']
            else:
                self.x_ticktext = None

            if 'y_ticktext' in args: 
                self.y_ticktext = args['y_ticktext']
            else:
                self.y_ticktext = None
    ...
    def prepare(self):
        ...
        # x_ticktext = x_data
        # x_tickvals = x_data
        self.x_tickvals = list(range(len(x_data)))
        self.y_tickvals = list(range(len(y_data)))
        self.z_tickvals = list(range(len(z_data)))

        # x_ticktext = [str(i) for i in x_ticktext]

        # self.x_ticktext = x_ticktext[::50]
        # self.y_ticktext = y_ticktext[::50]
        ...
        # ------------------------------------------------
        self.x_ticktext = x_data
        self.x_ticktext = [str(i) for i in self.x_ticktext]
        self.y_ticktext = y_data
        self.y_ticktext = [str(i) for i in self.y_ticktext]
        ...
        if self.to_file:
            ...
            plotly.offline.plot(self.fig, filename='1.html')
